 ...
 * Pricelist shortcode
 */
class zpMenuBoxShortcode extends ctShortcode implements ctVisualComposerShortcodeInterface {
    ...
    public function getChildShortcodeInfo() {
        return array('name' => 'menu_box_item_zp', 'min' => 1, 'max' => 50, 'default_qty' => 3);
    }
    /**
     * Returns config
     * @return null
	...
	public function getVisualComposerInfo() {
		return new ctVisualComposerInfo( $this, array(
		    'icon' => 'fa-file-o',
            'description'=> __('Box with menu', 'ct_theme'), ) );
	}
}

new zpMenuBoxShortcode();
