 ...
 * Pricelist shortcode
 */
class zpProductBoxShortcode extends ctShortcode implements ctVisualComposerShortcodeInterface
{
	...
	public function getVisualComposerInfo() {
		return new ctVisualComposerInfo( $this, array(
		    'icon' => 'fa-inbox',
            'description'=>__('Shows product in box', 'ct_theme'),
        ) );
	}
}

new zpProductBoxShortcode();
