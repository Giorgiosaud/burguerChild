 ...
 * Draws products
 */
class zpProductShortcode extends ctShortcodeQueryable  implements ctVisualComposerShortcodeInterface
{
    ...
    public function getAttributes()
    {
        ...
        return array(
            ...
            'id' => array('default' => '', 'type' => 'posts_select', 'post_type' => 'input', 'label' => __("Product ID", 'ct_theme'), 'help' =>__("Product ID. You can use slug or ID to find a product", 'ct_theme')),
            ...
            'style' => array('label' => __('Select style', 'ct_theme'), 'default' => '1', 'type' => 'select', 'options' => array(
                '1' => __('Sharp', 'ct_theme'),
                '2' => __('Rolled', 'ct_theme'),
                '3' => __('Scratch', 'ct_theme'),
            )),
	...
	public function getVisualComposerInfo() {
		return new ctVisualComposerInfo( $this, array(
		    'icon' => 'fa-cube',
            'description'=>__("Display product on page", 'ct_theme'),
        ) );
	}
}


new zpProductShortcode();